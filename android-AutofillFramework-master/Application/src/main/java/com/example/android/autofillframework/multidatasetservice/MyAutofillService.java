...
public class MyAutofillService extends AutofillService {
    ...
    public void onFillRequest(FillRequest request, CancellationSignal cancellationSignal,
        ...
        Log.e("GIULIO - getAllHints","Stampo gli Hints");

        List<String> list = autofillFields.getAllHints();
    ...
    // Funzione che viene chiamata quando premo Salva dopo aver inserito i dati
    @Override
    public void onSaveRequest(SaveRequest request, SaveCallback callback) {
        Log.e("GIULIO - MyAutofillService", "onSaveRequest");
    ...
    public void onConnected() {
        ...
        Log.e("GIULIO - MyAutofillService", "onConnected");
