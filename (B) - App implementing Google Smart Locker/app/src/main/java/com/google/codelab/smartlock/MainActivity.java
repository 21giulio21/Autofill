...
public class MainActivity extends AppCompatActivity implements
    ...
    private void setFragment(Intent intent) {
        ...
        if (intent != null && intent.hasCategory(Intent.CATEGORY_LAUNCHER)) {
            fragment = new com.ciao.SplashFragment();
            tag = SPLASH_TAG;
        } else {
            fragment = new com.ciao.SignInFragment();
            tag = SIGN_IN_TAG;
        }
    ...
    protected void goToContent() {
        startActivity(new Intent(this, com.ciao.ContentActivity.class));
        finish();
    }
    ...
    private void setSignInEnabled(boolean enable) {
        ...
        if (fragment != null && fragment.isVisible()) {
            ((com.ciao.SignInFragment) fragment).setSignEnabled(enable);
        }
    }
...
// **************** End callbacks here *********************
    ...
    private void processRetrievedCredential(Credential credential) {
        if (com.B.CodelabUtil.isValidCredential(credential)) {
            goToContent();
        } else {
