...
public class ContentActivity extends AppCompatActivity implements
    ...
    // This variable is used for disable autologin on this Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), com.ciao.MainActivity.class);
        ...
        changeCredsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(v.getContext(), com.ciao.ChangeCredActivity.class));
            }
        });
    }
