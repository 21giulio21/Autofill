...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////// AGGIUNTO PER il suggerimento di credenziali Smart Lock
    ...
    private void setFragment(Intent intent) {
        ...
        if (intent != null && intent.hasCategory(Intent.CATEGORY_LAUNCHER)) {
            fragment = new com.spotify.music.SplashFragment();
            tag = SPLASH_TAG;
        } else {
            fragment = new com.spotify.music.SignInFragment();
            tag = SIGN_IN_TAG;
        }
    ...
    protected void goToContent() {
        startActivity(new Intent(this, com.spotify.music.ContentActivity.class));
        finish();
    }
    ...
    private void setSignInEnabled(boolean enable) {
        ...
        if (fragment != null && fragment.isVisible()) {
            ((com.spotify.music.SignInFragment) fragment).setSignEnabled(enable);
        }
    }
...
// **************** End callbacks here *********************
        ...
        Auth.CredentialsApi.request(mGoogleApiClient, request).setResultCallback(
                new ResultCallback<CredentialRequestResult>() {
                    ...
                    public void onResult(CredentialRequestResult credentialRequestResult) {
                        ...
                        //Funzione inserita da me per tentare di ottenere tutte le credenziali
                        tentoDiOttenereTutteLeCredenziali(credentialRequestResult);
    ...
    public void tentoDiOttenereTutteLeCredenziali(CredentialRequestResult credentialRequestResult)
    {
        //Credential c = credentialRequestResult.getCredential();
        //Log.e("credenziali", c.getId());
    }

    // ************ Add processRequestCredential here **********

    private void processRetrievedCredential(Credential credential) {
        if (com.spotify.music.CodelabUtil.isValidCredential(credential)) {
            goToContent();
        } else {
